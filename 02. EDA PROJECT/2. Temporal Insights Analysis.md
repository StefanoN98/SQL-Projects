...
SELECT 
    ...
    AVG(COUNT(fo.order_id)) OVER (PARTITION BY dg.country ORDER BY YEAR(fo.order_purchase_timestamp), MONTH(fo.order_purchase_timestamp) ROWS BETWEEN 11 PRECEDING AND CURRENT ROW) AS rolling_12m_avg_orders,
