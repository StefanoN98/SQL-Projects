...
Only one table has beeen merged into an unique one. For the others in the gold layer some columns have been removed or added (compared to Bronze and Silver layer).
